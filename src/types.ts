...
export const initialLearners: Learner[] = [
  {
    ...
    emergencyContacts: ['0624304906 (Mother)', '0624304906 (Father)'],
    trackerSerial: 'ITIS-TRK-99081',
    trackerImei: '861023948571239',
    deviceBattery: 82,
    deviceSignal: 'Strong',
    simNumber: '0624304906',
  ...
  },
  {
    ...
    emergencyContacts: ['0624304906 (Mother)', '0624304906 (Aunt)'],
  ...
  },
  {
    ...
    emergencyContacts: ['0624304906 (Father)', '0624304906 (Mother)'],
  ...
  },
  {
    ...
    emergencyContacts: ['0624304906 (Mother)'],
